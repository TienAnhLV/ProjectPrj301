            ...
            <section class="container py-5">
                ...
                <c:forEach items="${listPSale}" var="i">
                    <div class="col-12 col-md-4 p-5 mt-3">
                        ...
                        <!-- Thêm phần giá tiền -->
                        <p class="text-center font-weight-bold text-decoration-line-through" style="color: red">$${i.price / (i.saleID/10)}</p>
                        <p class="text-center font-weight-bold">$${i.price}</p>
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled d-flex justify-content-between">
                                        <li class="text-right">${i.price}</li>
                                    </ul>
